...
(function () {
  var e, t, i, o, n;
  e = jQuery, t = window, i = document, n = e(t), e.fn.lazyload = function (r) {
    function f() {
      var t = 0;
      a.each(function () {
        var i = e(this);
    ...
    return r && (o !== r.failurelimit && (r.failure_limit = r.failurelimit, delete r.failurelimit), o !== r.effectspeed && (r.effect_speed = r.effectspeed, delete r.effectspeed), e.extend(h, r)), l = h.container === o || h.container === t ? n : e(h.container), 0 === h.event.indexOf("scroll") && l.bind(h.event, function () {
      ...
      var t = this,
        i = e(t);
      t.loaded = !1, (i.attr("src") === o || !1 === i.attr("src")) && i.is("img") && i.attr("src", h.placeholder), i.one("appear", function () {
        if (!this.loaded) {
          if (h.appear) {
            var o = a.length;
            h.appear.call(t, o, h);
    ...
    "below-the-fold": function belowTheFold(t) {
