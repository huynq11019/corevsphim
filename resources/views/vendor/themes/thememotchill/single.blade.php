    ...
    <div class="lg:container-sm">
        <div class="flex gap-10">
            <div class="grow min-w-0">
                ...
                @include('themes::thememotchill.inc.comment')
