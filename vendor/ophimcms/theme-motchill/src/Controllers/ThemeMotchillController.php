...
class ThememotchillController
{
    ...
    public function getMovieOverview(Request $request)
    {
        ...
        if(!$episode) {
            return view('themes::themeholy.404');
        }
    ...
    public function profile()
    {
        ...
        return view('themes::thememotchill.profile');
    }
    ...
    public function bookmark()
    {
        ...
        return view('themes::thememotchill.bookmark', compact('movies'));
    }
    ...
    public function history()
    {
        ...
        return view('themes::thememotchill.history', compact('movies'));
    }
}
